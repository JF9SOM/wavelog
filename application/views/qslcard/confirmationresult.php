			...
			<tbody>
				<?php foreach ($result as $qso) { ?>
					<tr>
						...
						<td style="text-align: center; vertical-align: middle;" ><?php echo display_qso_date($qso->col_time_on) . ' ' . display_qso_time($qso->col_time_on); ?></td>
						...
						echo display_qsl_datetime($qso->rxdate);
						if ($qso->qslcount ?? 0 != 0) {
